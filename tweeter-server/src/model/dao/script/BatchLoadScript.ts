...
const mainUsername = "@josh";
const baseFollowerAlias = "@bot";
const followerPassword = "password";
const followerImageUrl =
    "https://jgklingo-tweeter.s3.us-east-1.amazonaws.com/image/bot.png";
const baseFollowerFirstName = "Botty";
const baseFollowerLastName = "Bot";
